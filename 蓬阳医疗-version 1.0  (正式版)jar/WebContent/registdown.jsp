...
window.onload=function(){ 
	...
	if($("#name")!=null && $("#username")!=null && $("#pass1")!=null && 
			$("#pass2")!=null && $("#sh")!=null && $("h")!=null){
				...
				<div class="register-form">
					<form action="login/regist.do" method="post">
						<div class="fields-grid">
							...
							<div class="styled-input">
								<input id="h" type="text" name="hospital" required="">
								<label>本医院名<span style="color: red">  *</span></label>
								<span></span>
							</div>
							<div class="styled-input" style="display: none;">
							<span style="color: red">  *</span>
								<input type="radio" name="hospital_sign" onchange="showsh()" required="" value="0" />上级医院
								<input type="radio" name="hospital_sign" onchange="hidesh()" required="" value="1" checked="checked"/>下级医院
								<span></span>
							</div>
							<div class="styled-input" id="superhospital">
								<input id="sh" type="text" name="superiorhospital" required="">
							...
							<br/>
							 <label class="checkbox"><input type="checkbox" name="checkbox" checked><i></i>我已仔细阅读并接受本<a href="#">系统服务条款</a></label>
						</div>
