...
<script type="text/javascript">
	$(document).ready(function() {
				...
				if ($("#name").val != null && $("#username").val != null
						&& $("#pass1").val != null && $("#pass2").val != null
						&& $("#sh").val != null && password == repsword) {
					...
					<form action="login/regist.do" method="post">
						<div class="fields-grid">
							...
							<div class="styled-input">
								...
								<input id="sh" type="hidden" name="hospital" required="" /> <label>医院名<span
									id="shl" style="color: red"> *</span></label>
								<div align="center">
							...
							<div class="styled-input" style="display: none;">
								<input type="radio" name="hospital_sign" onclick="hidesh()"
									required="" value="0" checked="checked" />上级医院 <input
									type="radio" name="hospital_sign" onclick="showsh()"
									required="" value="1" />下级医院 <span></span>
							</div>
							<!-- 
							...
							<br /> <label class="checkbox"><input type="checkbox"
								name="checkbox" checked><i></i>我已仔细阅读并接受<a href="#">本系统服务条款</a></label>
						</div>
						<input id="rb" type="submit" value="注册" />
						<!-- &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;<a href="login.jsp">已有账号，点击此处登陆</a>-->
					</form>
				</div>
			</div>
