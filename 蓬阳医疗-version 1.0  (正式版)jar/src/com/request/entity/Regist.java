...
/**
 * @author admin 2017年12月15日上午10:22:13
 */
public class Regist {
	...
	public Regist(String name, String username, String password, String hospital, String office, String hospital_sign,
	...
	public String toString() {
		return "Regist [name=" + name + ", username=" + username + ", password=" + password + ", hospital=" + hospital
				+ ", office=" + office + ", hospital_sign=" + hospital_sign + ", superiorhospital=" + superiorhospital
				+ "]";
	}
